...
Revision ID: 884d789fc13f
Revises: a50cde241c4b
Create Date: 2023-09-21 14:50:51.738102
...
def upgrade():
    ...
    with op.batch_alter_table('baked_goods', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(batch_op.f('fk_baked_goods_game_id_bakeries'), 'bakeries', ['game_id'], ['id'])
...
def downgrade():
    ...
    with op.batch_alter_table('baked_goods', schema=None) as batch_op:
        batch_op.drop_constraint(batch_op.f('fk_baked_goods_game_id_bakeries'), type_='foreignkey')
        batch_op.drop_column('updated_at')
        batch_op.drop_column('created_at')
